// timing.mjs — $7,500/yr for 40 Years (04-video/)
//
// Single source of truth for the composition's reveal schedule.
// Reel #25 has 5 paragraphs (header + 3 concepts + footer).
//   HEADER:   4 words → ~1.6s → HEADER_REVEAL  1.5
//   C1:      25 words → ~8.6s → C1_REVEAL      8.5
//   C2:      31 words → ~10.7s → C2_REVEAL    10.5
//   C3:      30 words → ~10.4s → C3_REVEAL    10.0
//   OUTRO:   10 words → ~3.5s → OUTRO_REVEAL   3.5
//   sum = 34.0s.  VO_DURATION estimated ~33-35s at 1.40-1.50× atempo.

// ── Tunable constants (the only knobs in the system) ─────────────
export const FLASH_DURATION       = 1.0;
export const FLASH_FADE           = 0.2;
export const VO_DURATION          = 37.34; // voiceover.mp3 length — measured by ffprobe after regen @ 1.40x atempo

export const HEADER_REVEAL        = 1.5;
export const C1_REVEAL            = 8.5;
export const C2_REVEAL            = 10.5;
export const C3_REVEAL            = 10.0;
export const OUTRO_REVEAL         = 3.5;
