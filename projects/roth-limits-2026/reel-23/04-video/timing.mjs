// timing.mjs — The 5-Year Rule Trap (04-video/)
//
// Single source of truth for the composition's reveal schedule.
// Reel #23 has 5 paragraphs (header + 3 concepts + footer).
//   HEADER:   5 words → ~2.0s → HEADER_REVEAL  2.0
//   C1:      25 words → ~8.6s → C1_REVEAL      8.5
//   C2:      20 words → ~6.9s → C2_REVEAL      7.0
//   C3:      22 words → ~7.6s → C3_REVEAL      7.5
//   OUTRO:   12 words → ~4.1s → OUTRO_REVEAL   4.5
//   sum = 29.5s.  VO_DURATION estimated ~32-35s at 1.40-1.50× atempo.

// ── Tunable constants (the only knobs in the system) ─────────────
export const FLASH_DURATION       = 1.0;
export const FLASH_FADE           = 0.2;
export const VO_DURATION          = 31.12; // voiceover.mp3 length — measured by ffprobe after regen @ 1.50x atempo
