// timing.mjs — Roth withdrawal order (04-video/)
//
// Single source of truth for the composition's reveal schedule.
// Reel #13 has 5 paragraphs (header + 3 concepts + footer).
//   HEADER:   3 words → ~1.2s → HEADER_REVEAL  1.5
//   C1:      25 words → ~8.7s → C1_REVEAL      9.0
//   C2:      27 words → ~9.4s → C2_REVEAL     10.0
//   C3:      38 words → ~13.2s → C3_REVEAL    13.5
//   OUTRO:    5 words → ~2.0s → OUTRO_REVEAL   2.0
//   sum = 36.0s.  VO_DURATION estimated ~35-37s at 1.50× atempo.

// ── Tunable constants (the only knobs in the system) ─────────────
export const FLASH_DURATION       = 1.0;
export const FLASH_FADE           = 0.2;
export const VO_DURATION          = 33.34; // voiceover.mp3 length — measured at 1.50× atempo

export const HEADER_REVEAL        = 1.5;
export const C1_REVEAL            = 9.0;
export const C2_REVEAL            = 10.0;
export const C3_REVEAL            = 13.5;
