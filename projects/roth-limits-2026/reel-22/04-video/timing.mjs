// timing.mjs — Mega Backdoor Roth: $72,000 a Year (04-video/)
//
// Single source of truth for the composition's reveal schedule.
// Reel #22 has 5 paragraphs (header + 3 concepts + footer).
//   HEADER:   5 words → ~2.0s → HEADER_REVEAL  2.0
//   C1:      31 words → ~10.7s → C1_REVEAL    10.5
//   C2:      31 words → ~10.7s → C2_REVEAL    10.5
//   C3:      20 words → ~6.9s → C3_REVEAL      7.0
//   OUTRO:   11 words → ~3.8s → OUTRO_REVEAL   4.0
//   sum = 34.0s.  VO_DURATION estimated ~33-35s at 1.50× atempo.

// ── Tunable constants (the only knobs in the system) ─────────────
export const FLASH_DURATION       = 1.0;
export const FLASH_FADE           = 0.2;
export const VO_DURATION          = 36.13; // voiceover.mp3 length — measured by ffprobe after regen @ 1.55x atempo

export const HEADER_REVEAL        = 2.0;
export const C1_REVEAL            = 10.5;
export const C2_REVEAL            = 10.5;
export const C3_REVEAL            = 7.0;
