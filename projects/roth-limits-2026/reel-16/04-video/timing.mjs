// timing.mjs — Roth conversion: 3 numbers that decide (04-video/)
//
// Single source of truth for the composition's reveal schedule.
// Reel #16 has 5 paragraphs (header + 3 concepts + footer).
...
//   sum = 31.5s.  VO_DURATION estimated ~30-32s at 1.50× atempo.

// ── Tunable constants (the only knobs in the system) ─────────────
export const FLASH_DURATION       = 1.0;
export const FLASH_FADE           = 0.2;
export const VO_DURATION          = 30.28; // voiceover.mp3 length — measured at 1.70× atempo
