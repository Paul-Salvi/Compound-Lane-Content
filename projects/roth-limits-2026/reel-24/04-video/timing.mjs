// timing.mjs — Fall is the home stretch for Roth conversions (04-video/)
//
// Single source of truth for the composition's reveal schedule.
// Reel #24 has 5 paragraphs (header + 3 concepts + footer).
//   HEADER:   4 words → ~1.6s → HEADER_REVEAL  1.5
//   C1:      23 words → ~8.0s → C1_REVEAL      8.0
//   C2:      23 words → ~8.0s → C2_REVEAL      8.0
//   C3:      39 words → ~13.5s → C3_REVEAL    13.0
//   OUTRO:    5 words → ~2.0s → OUTRO_REVEAL   2.0
//   sum = 32.5s.  VO_DURATION estimated ~32-35s at 1.40-1.50× atempo.

// ── Tunable constants (the only knobs in the system) ─────────────
export const FLASH_DURATION       = 1.0;
export const FLASH_FADE           = 0.2;
export const VO_DURATION          = 37.23; // voiceover.mp3 length — measured by ffprobe after regen @ 1.10x atempo

export const HEADER_REVEAL        = 1.5;
export const C1_REVEAL            = 8.0;
export const C2_REVEAL            = 8.0;
export const C3_REVEAL            = 13.0;
