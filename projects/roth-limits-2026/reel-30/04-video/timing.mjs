// timing.mjs — Q3 Wrap: 92 Days to Max Your 2026 Roth (04-video/)
//
// Single source of truth for the composition's reveal schedule.
// Reel #30 has 5 paragraphs (header + 3 concepts + footer).
//   HEADER:    5 words → ~2.0s → HEADER_REVEAL  2.0
//   C1:       24 words → ~8.0s → C1_REVEAL      8.0
//   C2:       17 words → ~5.5s → C2_REVEAL      5.5
//   C3:       29 words → ~9.5s → C3_REVEAL      9.5
//   OUTRO:    23 words → ~7.5s → OUTRO_REVEAL   7.5
//   sum = 32.5s.  VO_DURATION estimated ~32-34s at 1.40-1.50× atempo.

// ── Tunable constants (the only knobs in the system) ─────────────
export const FLASH_DURATION       = 1.0;
export const FLASH_FADE           = 0.2;
export const VO_DURATION          = 32.10; // voiceover.mp3 length — measured by ffprobe after regen @ 1.50x atempo

export const HEADER_REVEAL        = 2.0;
export const C1_REVEAL            = 8.0;
export const C2_REVEAL            = 5.5;
export const C3_REVEAL            = 9.5;
export const OUTRO_REVEAL         = 7.5;
