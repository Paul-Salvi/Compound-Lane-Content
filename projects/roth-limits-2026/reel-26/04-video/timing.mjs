// timing.mjs — Roth IRA and Social Security (04-video/)
//
// Single source of truth for the composition's reveal schedule.
// Reel #26 has 5 paragraphs (header + 3 concepts + footer).
//   HEADER:   4 words → ~1.6s → HEADER_REVEAL  1.5
//   C1:      23 words → ~8.0s → C1_REVEAL      8.0
//   C2:      25 words → ~8.6s → C2_REVEAL      8.5
//   C3:      31 words → ~10.7s → C3_REVEAL    10.5
//   OUTRO:   14 words → ~4.8s → OUTRO_REVEAL   4.5
//   sum = 33.0s.  VO_DURATION estimated ~33-35s at 1.40-1.50× atempo.

// ── Tunable constants (the only knobs in the system) ─────────────
export const FLASH_DURATION       = 1.0;
export const FLASH_FADE           = 0.2;
export const VO_DURATION          = 33.07; // voiceover.mp3 length — measured by ffprobe after regen @ 1.50x atempo
