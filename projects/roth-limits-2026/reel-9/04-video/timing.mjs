// timing.mjs — Backdoor Roth (in 30 seconds) (04-video/)
//
// Single source of truth for the composition's reveal schedule.
// Reel #9 has 5 paragraphs (header + 3 concepts + footer). Word counts
// and estimated VO spans (Paul 1.50× for 5-segment VibeVoice):
//   HEADER:   4 words → ~1.6s → HEADER_REVEAL  2.0
//   C1:      21 words → ~7.3s → C1_REVEAL      8.0
//   C2:      31 words → ~10.7s → C2_REVEAL    11.0
//   C3:      29 words → ~10.0s → C3_REVEAL    10.5
//   OUTRO:   11 words → ~3.8s → OUTRO_REVEAL   4.0
//   sum = 35.5s.  VO_DURATION estimated ~35s native WAV (1.50× atempo).

// ── Tunable constants (the only knobs in the system) ─────────────
export const FLASH_DURATION       = 1.0;
export const FLASH_FADE           = 0.2;
export const VO_DURATION          = 35.30; // voiceover.mp3 length — measured by ffprobe after 1.50x atempo regen

export const HEADER_REVEAL        = 2.0;
export const C1_REVEAL            = 8.0;
export const C2_REVEAL            = 11.0;
export const C3_REVEAL            = 10.5;
export const OUTRO_REVEAL         = 4.0;
