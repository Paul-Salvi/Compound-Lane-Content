// timing.mjs — Roth at 60: Age 59½ + 5 Years (04-video/)
//
// Single source of truth for the composition's reveal schedule.
// Reel #29 has 5 paragraphs (header + 3 concepts + footer).
//   HEADER:    5 words → ~2.0s → HEADER_REVEAL  2.0
//   C1:       20 words → ~6.5s → C1_REVEAL      6.5
//   C2:       27 words → ~8.5s → C2_REVEAL      8.5
//   C3:       27 words → ~8.5s → C3_REVEAL      8.5
//   OUTRO:    19 words → ~6.0s → OUTRO_REVEAL   6.0
//   sum = 33.5s.  VO_DURATION estimated ~33-35s at 1.40-1.50× atempo.

// ── Tunable constants (the only knobs in the system) ─────────────
export const FLASH_DURATION       = 1.0;
export const FLASH_FADE           = 0.2;
export const VO_DURATION          = 29.87; // voiceover.mp3 length — measured by ffprobe after regen @ 1.50x atempo

export const HEADER_REVEAL        = 1.5;
export const C1_REVEAL            = 5.5;
export const C2_REVEAL            = 7.5;
export const C3_REVEAL            = 7.5;
export const OUTRO_REVEAL         = 6.0;
