// timing.mjs — Pro-rata rule with $90,000 example (04-video/)
//
// Single source of truth for the composition's reveal schedule.
// Reel #10 has 5 paragraphs (header + 3 concepts + footer). Word counts
// and estimated VO spans (Paul 1.50× for 5-segment VibeVoice):
//   HEADER:   4 words → ~1.6s → HEADER_REVEAL  2.0
//   C1:      29 words → ~10.0s → C1_REVEAL    10.5
//   C2:      31 words → ~10.7s → C2_REVEAL    11.0
//   C3:      26 words → ~9.0s → C3_REVEAL      9.5
//   OUTRO:    4 words → ~1.6s → OUTRO_REVEAL   2.0
...
export const VO_DURATION          = 35.58; // voiceover.mp3 length — measured by ffprobe after 1.60x atempo regen
