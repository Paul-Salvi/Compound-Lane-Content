// timing.mjs — Form 8606: the form that does the work (04-video/)
//
// Single source of truth for the composition's reveal schedule.
// Reel #17 has 5 paragraphs (header + 3 concepts + footer).
//   HEADER:   5 words → ~2.0s → HEADER_REVEAL  2.0
//   C1:      24 words → ~8.3s → C1_REVEAL      8.5
//   C2:      22 words → ~7.6s → C2_REVEAL      8.0
//   C3:      35 words → ~12.1s → C3_REVEAL    12.5
//   OUTRO:    5 words → ~2.0s → OUTRO_REVEAL   2.0
//   sum = 33.0s.  VO_DURATION estimated ~30-33s at 1.50-1.70× atempo.

// ── Tunable constants (the only knobs in the system) ─────────────
export const FLASH_DURATION       = 1.0;
export const FLASH_FADE           = 0.2;
export const VO_DURATION          = 33.06; // voiceover.mp3 length — measured at 1.50× atempo
