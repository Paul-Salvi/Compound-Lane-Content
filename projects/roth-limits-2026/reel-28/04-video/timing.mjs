// timing.mjs — Roth at 22: 3 Mistakes I Made (04-video/)
//
// Single source of truth for the composition's reveal schedule.
// Reel #28 has 5 paragraphs (header + 3 concepts + footer).
//   HEADER:    4 words → ~1.6s → HEADER_REVEAL  1.6
//   C1:       18 words → ~6.5s → C1_REVEAL      6.5
//   C2:       30 words → ~10.0s → C2_REVEAL    10.0
//   C3:       28 words → ~9.5s → C3_REVEAL      9.5
//   OUTRO:    20 words → ~7.0s → OUTRO_REVEAL   7.0
//   sum = 34.6s.  VO_DURATION estimated ~34-36s at 1.40-1.50× atempo.

// ── Tunable constants (the only knobs in the system) ─────────────
export const FLASH_DURATION       = 1.0;
export const FLASH_FADE           = 0.2;
export const VO_DURATION          = 26.67; // voiceover.mp3 length — measured by ffprobe after regen @ 1.50x atempo

export const HEADER_REVEAL        = 1.6;
export const C1_REVEAL            = 5.0;
export const C2_REVEAL            = 7.5;
export const C3_REVEAL            = 7.5;
export const OUTRO_REVEAL         = 5.0;
