# 01-text/ — Platform copy for roth-ira-phaseout-single (Roth Limits 2026 / Reel #4)

This directory holds the YouTube / Instagram / Twitter copy that ships with
the **Make $153k? Your Roth just started shrinking** reel, ready to paste into each platform at upload time.

## Source numbers (locked, trace to `01-content/roth-ira-phaseout-single.json`)

- $153,000 — single filer phase-out floor (2026)
- $168,000 — single filer phase-out ceiling (2026)
- $15,000 — phase-out window width
- MAGI — Modified Adjusted Gross Income, the line that triggers the phase-out
- Backdoor Roth — workaround above $168k
