# 01-text/ — Platform copy for roth-ira-teen-three-numbers (Roth Limits 2026 / Reel #3)

This directory holds the YouTube / Instagram / Twitter copy that ships with
the **3 numbers for a teen's first Roth** reel, ready to paste into each platform at upload time.

## Source numbers (locked, trace to `01-content/roth-ira-teen-three-numbers.json`)

- $7,500 — 2026 base Roth IRA contribution limit
- $3,000 — example teen's summer-job income
- "earned income only" requirement — IRC §408A
- Age 18 — custodial Roth conversion age
