...
#
# Project: roth-limits-2026/reel-3 (04-video/, audio-only)

set -euo pipefail

cd "$(dirname "$0")"
# 04-video/ is at projects/{parent}/{slug}/04-video/, so repo root is
# 4 levels up. (reel-2 sits one folder deeper than the canonical DCA layout.)
REPO_ROOT="$(cd ../../../.. && pwd)"
