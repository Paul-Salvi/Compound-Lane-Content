// timing.mjs — Roth Labor Day Fund (04-video/)
//
// Single source of truth for the composition's reveal schedule.
// Reel #7 has 6 paragraphs (header + 4 concepts + footer). Word counts
// and estimated VO spans (Paul 1.50× for 6-segment VibeVoice):
//   HEADER:   5 words → ~2.0s → HEADER_REVEAL  2.5
//   C1:      18 words → ~6.2s → C1_REVEAL      6.5
//   C2:      30 words → ~10.3s → C2_REVEAL    10.5
//   C3:      29 words → ~10.0s → C3_REVEAL    10.5
//   C4:       8 words → ~2.8s → C4_REVEAL      3.0
//   OUTRO:    5 words → ~2.0s → OUTRO_REVEAL   2.5
//   sum = 35.5s.  VO_DURATION estimated ~36s native WAV (1.50× atempo).

// ── Tunable constants (the only knobs in the system) ─────────────
export const FLASH_DURATION       = 1.0;
export const FLASH_FADE           = 0.2;
export const VO_DURATION          = 31.47; // voiceover.mp3 length — measured by ffprobe after 1.50x atempo regen

export const HEADER_REVEAL        = 2.5;
export const C1_REVEAL            = 6.5;
export const C2_REVEAL            = 10.5;
export const C3_REVEAL            = 10.5;
export const C4_REVEAL            = 3.0;
