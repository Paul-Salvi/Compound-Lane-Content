// timing.mjs — Roth IRA vs Roth 401(k): the gap (04-video/)
//
// Single source of truth for the composition's reveal schedule.
// Reel #12 has 5 paragraphs (header + 3 concepts + footer).
//   HEADER:   5 words → ~2.0s → HEADER_REVEAL  2.0
//   C1:      21 words → ~7.3s → C1_REVEAL      7.5
//   C2:      25 words → ~8.7s → C2_REVEAL      9.0
//   C3:      26 words → ~9.0s → C3_REVEAL      9.0
//   OUTRO:    7 words → ~2.5s → OUTRO_REVEAL   2.5
//   sum = 30.0s.  VO_DURATION estimated ~30-32s at 1.50-1.60× atempo.

// ── Tunable constants (the only knobs in the system) ─────────────
export const FLASH_DURATION       = 1.0;
export const FLASH_FADE           = 0.2;
export const VO_DURATION          = 35.11; // voiceover.mp3 length — measured at 1.50× atempo

export const HEADER_REVEAL        = 2.0;
export const C1_REVEAL            = 7.5;
export const C2_REVEAL            = 9.0;
export const C3_REVEAL            = 9.0;
