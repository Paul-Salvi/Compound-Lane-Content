// timing.mjs — Roth 30-Year Compounding (04-video/)
//
// Single source of truth for the composition's reveal schedule.
// Reel #8 has 6 paragraphs (header + 4 concepts + footer). Word counts
// and estimated VO spans (Paul 1.50× for 6-segment VibeVoice):
//   HEADER:   4 words → ~1.6s → HEADER_REVEAL  2.0
//   C1:      22 words → ~7.6s → C1_REVEAL      8.0
//   C2:      28 words → ~9.7s → C2_REVEAL     10.0
//   C3:      27 words → ~9.3s → C3_REVEAL      9.5
//   C4:       5 words → ~1.7s → C4_REVEAL      2.0
//   OUTRO:    5 words → ~2.0s → OUTRO_REVEAL   2.5
//   sum = 34.0s.  VO_DURATION estimated ~36s native WAV (1.50× atempo).

// ── Tunable constants (the only knobs in the system) ─────────────
export const FLASH_DURATION       = 1.0;
export const FLASH_FADE           = 0.2;
export const VO_DURATION          = 35.67; // voiceover.mp3 length — measured by ffprobe after 1.60x atempo regen

export const HEADER_REVEAL        = 2.0;
export const C1_REVEAL            = 8.0;
export const C2_REVEAL            = 10.0;
export const C3_REVEAL            = 9.5;
export const C4_REVEAL            = 2.0;
