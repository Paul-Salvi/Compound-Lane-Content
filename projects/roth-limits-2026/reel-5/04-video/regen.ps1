...
#          TTS_SPEED      (default: 1.70 — calibrated for 6-segment VibeVoice
#                          scripts to land at the 36-40s ceiling of
#                          pacing-rules-v1.md. With 5-6 VibeVoice segments
#                          each costing ~7-10s base, 1.20× under-runs at
#                          ~46s; 1.50× lands at ~43s; 1.70× lands at ~38s.)
#
# Project: roth-limits-2026/reel-5 (04-video/, audio-only)
...
$Speed = if ($env:TTS_SPEED) { $env:TTS_SPEED } else { '1.70' }
