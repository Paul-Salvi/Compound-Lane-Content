// timing.mjs — Roth vs Traditional (04-video/)
//
// Single source of truth for the composition's reveal schedule.
// Reel #6 has 6 paragraphs (header + 4 concepts + footer). Word counts
...
//   C2:      24 words → ~8.3s → C2_REVEAL      8.5
//   C3:      24 words → ~8.3s → C3_REVEAL      8.5
//   C4:       6 words → ~2.1s → C4_REVEAL      2.5
//   OUTRO:    5 words → ~2.0s → OUTRO_REVEAL   2.5
//   sum = 34.5s.  VO_DURATION estimated ~36s native WAV (1.50× atempo).

// ── Tunable constants (the only knobs in the system) ─────────────
export const FLASH_DURATION       = 1.0;
export const FLASH_FADE           = 0.2;
export const VO_DURATION          = 35.12;  // voiceover.mp3 length — measured by ffprobe after regen (1.50× atempo)

export const HEADER_REVEAL        = 2.5;
export const C1_REVEAL            = 10.0;
export const C2_REVEAL            = 8.5;
export const C3_REVEAL            = 8.5;
export const C4_REVEAL            = 2.5;
