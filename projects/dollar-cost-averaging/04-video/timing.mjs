// projects/dollar-cost-averaging/04-video/timing.mjs
...
export const VO_DURATION          = 135.8; // voiceover.mp3 length — must match the actual MP3 (measured by faster-whisper)
...
export const OUTRO_REVEAL         = 10.8;  // outro ("That's dollar-cost averaging…")  (trimmed -1.2s so REVEALs sum to VO_DURATION=135.8)
